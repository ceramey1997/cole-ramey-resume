...
function PersonalProjects() {
    ...
    <div className="development">
        ...
        <div className="single-project">
            <p className="project-title" >Blues Bot (<a href="https://github.com/ceramey1997/BluesBot" className="project-title">Github</a>)</p>
        ...
        <div className="single-project">
            <p className="project-title">Gifty ICard (<a href="https://apps.apple.com/us/app/gifty-icard/id1579197194" className="project-title">IOS App Store</a>, <a href="https://github.com/ceramey1997/GiftCardTracker" className="project-title">Github Page</a>)</p>
